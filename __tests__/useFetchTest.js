...
it('should not make an API get request without a url', async () => {
...
it('should set results when url is present', async () => {
...
it('should make an API get request when url is present', async () => {
  const spy = jest.spyOn(axios, 'get')
  mockAxios()
